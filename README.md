...
The main model developments are: 
...
The Ireland-specific emissions file generated by the data-transfer step is then read by the FaIR script `countrylevel_IRL.py`. More information documented in this [file](https://github.com/MaREI-EPMG/TIM-LEAF/blob/main/TIM-LEAF-FaIR_workflow/fair/fair_readme.md). 
