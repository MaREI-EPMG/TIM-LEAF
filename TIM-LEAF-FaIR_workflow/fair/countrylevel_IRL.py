# This is a script to set up and run the fair model v2.1.3 based on the NZ CCC script
...
IRL_scenario = "S3" # BAU, S1, S2, S3; the script is run for each of Ireland's emissions scenario individually
...
IRL_scenarios_file = 'data/IRL_histWheatley2021_' + IRL_scenario + '.csv'
